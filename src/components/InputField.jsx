    ...
    <div className="mb-4">
      ...
      >
        ...
        <input
          ...
          className={`flex-1 bg-transparent pl-3 ${isPassword && showPasswordToggle ? "pr-10" : "pr-2"} py-2 text-gray-700 placeholder-gray-300 focus:outline-none tracking-widest text-sm`}
        />
